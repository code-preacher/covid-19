...
<?php
include '../config.php';
$q1=mysqli_query($con,"select * from suggestion  ");
$qr1=mysqli_num_rows($q1);

$q2=mysqli_query($con,"select * from user_login  ");
$qr2=mysqli_num_rows($q2);

$q3=mysqli_query($con,"select * from report ");
...
include "inc/sidebar.php";
 ...
 <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                   <a href="view_diagnose.php"> <span><i class="fa fa-book f-s-50 color-success"></i></span></a>
                                </div>
                                <div class="media-body media-text-right">
                                    <h2>
                                        <?php 
                                    ...
                                    <p class="m-b-0"><a href="view_diagnose.php">Total Diagnostic Report</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-3">
                        <div class="card p-30">
                            <div class="media">
                                <div class="media-left meida media-middle">
                                 <a href="view_user.php">   <span><i class="fa fa-users f-s-50 color-success"></i></span></a>
                                </div>
                                <div class="media-body media-text-right">
                                   <h2>
                                        <?php 
                                    ...
                                    <p class="m-b-0"><a href="view_user.php">Total Users</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
